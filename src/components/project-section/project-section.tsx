    ...
    return (
        <div className="projects" id="projects">
            ...
            <div className="projects_tuple">
                ...
                <div className="projects_tuple-index">
                    <ProjectCards images={RoamingApp} title="Roaming App" description="Roaming is a visual storytelling app that helps users capture raw, aesthetic moments and build a digital footprint. Unlike typical photo-sharing platforms focused on selfies, Roaming highlights places, landscapes, and cityscapes—encouraging users to tell stories through their surroundings." link="https://github.com/namneyugn21/Roaming-App" />
                </div>
                <div className="projects_tuple-index">
