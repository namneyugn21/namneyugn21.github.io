    ...
    return (
        <div className="card_container">
            <div className="card_container-image">
                <img src={images} alt="project-image" />
            </div>
            <div className="card_container-title">
                <a className="card_container-title-text roboto-slab-light" href={link} target="_blank">{title}</a>
                <a href={link} target="_blank"><FontAwesomeIcon icon={faArrowUpRightFromSquare} className="card_container-title-icon" /></a>
            </div>
